...
Initializes a new instance of the [DocReference](DocReference) class.
...
Initializes a new instance of the [DocReference](DocReference) class with a raw reference.
