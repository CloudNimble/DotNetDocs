---
title: SimpleEnum
description: "A simple enum with default int underlying type."
icon: lock
tag: "SEALED"
keywords: ['SimpleEnum', 'CloudNimble.DotNetDocs.Tests.Shared.Enums.SimpleEnum', 'CloudNimble.DotNetDocs.Tests.Shared.Enums', 'class', 'System.Enum']
---
