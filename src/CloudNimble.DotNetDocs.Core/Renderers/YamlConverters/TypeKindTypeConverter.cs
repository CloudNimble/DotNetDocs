...
namespace CloudNimble.DotNetDocs.Core.Renderers.YamlConverters
{
    ...
    /// </summary>
    public class TypeKindTypeConverter : IYamlTypeConverter
    {
        ...
        public bool Accepts(Type type) => type == typeof(TypeKind);
        ...
        public object? ReadYaml(IParser parser, Type type, ObjectDeserializer rootDeserializer) 
            => throw new NotImplementedException("Reading TypeKind from YAML is not supported");
