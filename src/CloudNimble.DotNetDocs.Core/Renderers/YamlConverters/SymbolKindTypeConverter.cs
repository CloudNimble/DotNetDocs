...
namespace CloudNimble.DotNetDocs.Core.Renderers.YamlConverters
{
    ...
    /// </summary>
    public class SymbolKindTypeConverter : IYamlTypeConverter
    {
        ...
        public bool Accepts(Type type) => type == typeof(SymbolKind);
        ...
        public object? ReadYaml(IParser parser, Type type, ObjectDeserializer rootDeserializer) 
            => throw new NotImplementedException("Reading SymbolKind from YAML is not supported");
