...
The [DocsJsonConfig](DocsJsonConfig) instance loaded from the file system or string content.
...
Type: `Mintlify.Core.Models.DocsJsonConfig`
A new [DocsJsonConfig](DocsJsonConfig) instance with default values.
