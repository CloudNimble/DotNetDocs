...
Initializes a new instance of the [FaviconConfig](FaviconConfig) class.
...
Initializes a new instance of the [FaviconConfig](FaviconConfig) class with a single favicon path.
