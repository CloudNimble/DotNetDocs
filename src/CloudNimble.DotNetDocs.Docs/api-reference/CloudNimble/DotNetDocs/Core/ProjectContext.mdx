...
Initializes a new instance of [ProjectContext](../ProjectContext.md) with default settings.
...
Initializes a new instance of [ProjectContext](../ProjectContext.md) with optional included members and referenced assemblies.
