...
Initializes a new instance of [ProjectContext](ProjectContext) with default settings.
...
Initializes a new instance of [ProjectContext](ProjectContext) with optional included members and referenced assemblies.
...
When [FileNamingOptions.NamespaceMode](../CloudNimble/DotNetDocs/Core/Configuration/FileNamingOptions#namespacemode) is [NamespaceMode.Folder](../CloudNimble/DotNetDocs/Core/Configuration/NamespaceMode#folder),
            this returns a path with folders for each namespace part (e.g., "System/Collections/Generic").
            When using [NamespaceMode.File](../CloudNimble/DotNetDocs/Core/Configuration/NamespaceMode#file), this returns an empty string as no folder
