...
Initializes a new instance of the [FileNamingOptions](../FileNamingOptions.md) class with default settings.
...
Initializes a new instance of the [FileNamingOptions](../FileNamingOptions.md) class with the specified settings.
...
The namespace organization mode. Default is `File`.
...
This setting is only used when [NamespaceMode](../NamespaceMode.md) is set to `File`.
            When using `Folder`, this setting is ignored as namespaces
...
Creates a copy of the current [FileNamingOptions](../FileNamingOptions.md) instance.
