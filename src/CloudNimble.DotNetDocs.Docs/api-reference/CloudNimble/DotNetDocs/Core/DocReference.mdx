...
Initializes a new instance of the [DocReference](../DocReference.md) class.
...
Initializes a new instance of the [DocReference](../DocReference.md) class with a raw reference.
...
Type: `string?`
The relative path from the current document to the target, or null if unresolved.
