...
### <Icon icon="function" iconType="duotone" color="#419AC5" size={24} style={{ paddingRight: '8px' }} /> RenderAsync <DocsBadge text="Abstract" variant="warning" />
...
### <Icon icon="function" iconType="duotone" color="#419AC5" size={24} style={{ paddingRight: '8px' }} /> RenderPlaceholdersAsync <DocsBadge text="Abstract" variant="warning" />
