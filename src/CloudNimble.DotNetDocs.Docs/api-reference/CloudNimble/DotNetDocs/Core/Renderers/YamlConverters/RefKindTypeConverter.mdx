---
title: RefKindTypeConverter
description: "Custom type converter for RefKind enum."
icon: file-brackets-curly
keywords: ['RefKindTypeConverter', 'CloudNimble.DotNetDocs.Core.Renderers.YamlConverters.RefKindTypeConverter', 'CloudNimble.DotNetDocs.Core.Renderers.YamlConverters', 'class', 'System.Object', 'YamlDotNet.Serialization.IYamlTypeConverter']
---
...
```csharp
CloudNimble.DotNetDocs.Core.Renderers.YamlConverters.RefKindTypeConverter
```
