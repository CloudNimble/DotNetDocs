...
Initializes a new instance of the [DocsJsonManager](../DocsJsonManager.md) class.
...
Initializes a new instance of the [DocsJsonManager](../DocsJsonManager.md) class with the specified file path.
