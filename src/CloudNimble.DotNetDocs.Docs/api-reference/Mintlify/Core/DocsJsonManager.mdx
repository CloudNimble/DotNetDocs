...
Initializes a new instance of the [DocsJsonManager](DocsJsonManager) class.
...
Initializes a new instance of the [DocsJsonManager](DocsJsonManager) class with the specified file path.
...
The [DocsJsonConfig](../Mintlify/Core/Models/DocsJsonConfig) instance loaded from the file system or string content.
...
Type: `Mintlify.Core.Models.DocsJsonConfig`
A new [DocsJsonConfig](../Mintlify/Core/Models/DocsJsonConfig) instance with default values.
