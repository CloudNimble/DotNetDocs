---
title: FrontChatConfig
description: "Represents the configuration for Front chat widget integration."
icon: file-brackets-curly
keywords: ['FrontChatConfig', 'Mintlify.Core.Models.Integrations.FrontChatConfig', 'Mintlify.Core.Models.Integrations', 'class', 'System.Object']
---
...
```csharp
Mintlify.Core.Models.Integrations.FrontChatConfig
```
...
### <Icon icon="tag" iconType="duotone" color="#419AC5" size={24} className="mr-2" /> SnippetId
