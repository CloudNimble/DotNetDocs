...
description: "Represents the configuration for telemetry and feedback functionality."
icon: file-brackets-curly
keywords: ['TelemetryConfig', 'Mintlify.Core.Models.Integrations.TelemetryConfig', 'Mintlify.Core.Models.Integrations', 'class', 'System.Object']
---
...
```csharp
Mintlify.Core.Models.Integrations.TelemetryConfig
```
