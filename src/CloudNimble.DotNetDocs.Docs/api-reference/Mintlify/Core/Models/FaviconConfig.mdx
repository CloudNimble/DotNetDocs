...
Initializes a new instance of the [FaviconConfig](../FaviconConfig.md) class.
...
Initializes a new instance of the [FaviconConfig](../FaviconConfig.md) class with a single favicon path.
