...
### <Icon icon="tag" iconType="duotone" color="#419AC5" size={24} className="mr-2" /> Codeblocks
...
### <Icon icon="tag" iconType="duotone" color="#419AC5" size={24} className="mr-2" /> Eyebrows
...
### <Icon icon="tag" iconType="duotone" color="#419AC5" size={24} className="mr-2" /> Latex
...
```csharp
public System.Nullable<bool> Latex { get; set; }
```
