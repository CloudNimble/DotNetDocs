...
<Steps>
  <Step title="Install" titleSize="h2" iconType="duotone">
    ...
    By default, this creates a Mintlify documentation project. To use a different documentation type:

    ```bash
    dotnet docs add --type DocFX
    ```

    <Note>You can see more of the optional arguments and supported types in the [CLI Reference](/guides/cli-reference) docs.</Note>
