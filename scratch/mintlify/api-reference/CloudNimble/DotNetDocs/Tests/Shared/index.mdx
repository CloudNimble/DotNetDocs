...
graph TD
    ...
    style C fill:#a78bfa,stroke:#7c3aed,stroke-width:2px
    style D fill:#ddd6fe,stroke:#a78bfa,stroke-width:1px
    style E fill:#ddd6fe,stroke:#a78bfa,stroke-width:1px
    style F fill:#ddd6fe,stroke:#a78bfa,stroke-width:1px
    style G fill:#ddd6fe,stroke:#a78bfa,stroke-width:1px
```
