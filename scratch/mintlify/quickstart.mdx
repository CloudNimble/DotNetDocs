---
title: Quick Start
description: Get started with CloudNimble.DotNetDocs in minutes
icon: play
---

# Quick Start Guide

Get up and running with CloudNimble.DotNetDocs documentation in just a few steps.

<Steps>
  <Step title="Install the Package">
    Install the CloudNimble.DotNetDocs package from NuGet:
    
    <CodeGroup>
      ```bash .NET CLI
      dotnet add package CloudNimble.DotNetDocs.Tests.Shared
      ```
      
      ```xml PackageReference
      <PackageReference Include="CloudNimble.DotNetDocs.Tests.Shared" Version="1.0.0" />
      ```
      
      ```powershell Package Manager
      Install-Package CloudNimble.DotNetDocs.Tests.Shared
      ```
    </CodeGroup>
  </Step>
