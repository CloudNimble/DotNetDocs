...
Initializes a new instance of the [DocumentationReference](/test/api-reference/CloudNimble/DotNetDocs/Core/DocumentationReference) class.
...
Initializes a new instance of the [DocumentationReference](/test/api-reference/CloudNimble/DotNetDocs/Core/DocumentationReference) class with a project path.
