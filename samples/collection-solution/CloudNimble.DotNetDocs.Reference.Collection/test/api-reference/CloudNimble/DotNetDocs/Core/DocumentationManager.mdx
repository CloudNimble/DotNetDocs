...
This class manages the complete documentation lifecycle including enrichment,
            transformation, and rendering. It handles [AssemblyManager](/test/api-reference/CloudNimble/DotNetDocs/Core/AssemblyManager) creation,
...
Initializes a new instance of the [DocumentationManager](/test/api-reference/CloudNimble/DotNetDocs/Core/DocumentationManager) class.
...
Disposes of all cached [AssemblyManager](/test/api-reference/CloudNimble/DotNetDocs/Core/AssemblyManager) instances.
