...
Inherits from [DocEntity](/test/api-reference/CloudNimble/DotNetDocs/Core/DocEntity) to provide standard documentation properties
...
Initializes a new instance of the [DocEnumValue](/test/api-reference/CloudNimble/DotNetDocs/Core/DocEnumValue) class.
...
### <Icon icon="tag" iconType="duotone" color="#419AC5" size={24} className="mr-2" /> NumericValue
