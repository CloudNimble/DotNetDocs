...
description: "Base class for Markdown-based documentation reference handlers providing content path rewriting."
icon: shapes
tag: "ABSTRACT"
...
Base class for Markdown-based documentation reference handlers providing content path rewriting.
...
## Remarks
            ...
            This abstract class extends [DocReferenceHandlerBase](/test/api-reference/CloudNimble/DotNetDocs/Core/DocReferenceHandlerBase) to add Markdown-specific
