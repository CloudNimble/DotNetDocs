...
## Remarks
            ...
            This interface follows the same pattern as [IDocEnricher](/test/api-reference/CloudNimble/DotNetDocs/Core/IDocEnricher), [IDocTransformer](/test/api-reference/CloudNimble/DotNetDocs/Core/IDocTransformer),
            and [IDocRenderer](/test/api-reference/CloudNimble/DotNetDocs/Core/IDocRenderer) for format-specific documentation processing.
...
The [SupportedDocumentationType](/test/api-reference/CloudNimble/DotNetDocs/Core/Configuration/SupportedDocumentationType) that this handler can process.
