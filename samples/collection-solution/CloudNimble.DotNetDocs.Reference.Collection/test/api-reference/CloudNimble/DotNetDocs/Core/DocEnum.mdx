...
Contains metadata about an enum type and its values, extracted from Roslyn symbols
            and enhanced with conceptual documentation. Inherits from [DocType](/test/api-reference/CloudNimble/DotNetDocs/Core/DocType) but
...
Initializes a new instance of the [DocEnum](/test/api-reference/CloudNimble/DotNetDocs/Core/DocEnum) class.
...
Gets or sets the underlying type of the enum as a [DocReference](/test/api-reference/CloudNimble/DotNetDocs/Core/DocReference).
