...
### <Icon icon="tag" iconType="duotone" color="#419AC5" size={24} className="mr-2" /> Indexing
...
### <Icon icon="tag" iconType="duotone" color="#419AC5" size={24} className="mr-2" /> Metatags
