...
<Project Sdk="DotNetDocs.Sdk/1.2.0-preview.1">
  ...
  <PropertyGroup>
    ...
    <MintlifyTemplate>
      ...
      <!-- Navigation configuration (1.1.0+) -->
...
<CardGroup cols={2}>
  <Card title="Pipeline Overview" icon="faucet-drip" href="/test/guides/pipeline">
    Learn how the documentation pipeline works
  </Card>
  <Card title="Conceptual Docs" icon="book" href="/test/guides/conceptual-docs">
