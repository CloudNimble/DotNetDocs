...
<CardGroup cols={2}>
  <Card title="Conceptual Documentation" icon="book" href="/test/guides/conceptual-docs">
  ...
  <Card title="ProjectContext Reference" icon="gear" href="/test/api-reference/CloudNimble/DotNetDocs/Core/ProjectContext">
    Complete ProjectContext API reference
  </Card>

  <Card title="DocumentationManager Reference" icon="gears" href="/test/api-reference/CloudNimble/DotNetDocs/Core/DocumentationManager">
