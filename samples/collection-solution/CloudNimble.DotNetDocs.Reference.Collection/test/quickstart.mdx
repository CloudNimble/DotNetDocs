...
<Steps>
  <Step title="Install" titleSize="h2" iconType="duotone">
    ...
    <Note>The CLI automatically queries NuGet.org for the latest SDK version. See more options in the [CLI Reference](/test/guides/cli-reference) docs.</Note>
    ...
    <Tabs>
      ...
      <Tab title="Preview (1.2.0-preview.1)">
        ```xml
    ...
    <Note>You can see more of how to configure your .docsproj file in the [.docsproj Reference](/test/guides/docsproj) docs.</Note>
