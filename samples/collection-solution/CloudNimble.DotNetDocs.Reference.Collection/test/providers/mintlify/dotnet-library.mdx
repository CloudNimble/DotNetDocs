...
<CardGroup cols={2}>
  <Card title="Navigation Generation" icon="sitemap" href="/test/providers/mintlify/navigation">
    Learn how MintlifyRenderer uses DocsJsonManager to build navigation
  </Card>
  <Card title="Mintlify Provider Overview" icon="sparkles" href="/test/providers/mintlify/index">
    Complete guide to the Mintlify provider features
  </Card>
  <Card title="DocsJsonManager API" icon="book" href="/test/api-reference/Mintlify/Core/DocsJsonManager">
