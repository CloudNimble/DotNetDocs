...
<CardGroup cols={2}>
  ...
  <Card title="Project Configuration" icon="gear" href="/test/guides/configuration">
    Configure .docsproj files and build properties
  </Card>
  <Card title="Conceptual Docs Guide" icon="file-pen" href="/test/guides/conceptual-docs">
